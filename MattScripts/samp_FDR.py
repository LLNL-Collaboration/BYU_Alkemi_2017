...
if __name__ == '__main__':
    ...
    #gets sample of zone ID's (samp)
    ids1=list(range(712,1450))
    ids14 = list(range(10117,10836))
    IDS = ids1 + ids14
    samp=np.random.choice(IDS,500)
    

    # makes csv file for each zone in samp
    count = 0
    for ID in samp:  
        (run, zone) = (0,ID)
        ...
        filename = 'data_files/pass_data_' + str(count) + '.csv'
        df.to_csv(filename,index = False)
        print('Completed: ' + str(count) + ' of '+str(len(samp)+len(reb_list)-1))
        count +=1
 
    #include rebecca's zones that are close to failure
    reb_list=[(0,10802),(0,10806), (0,10826),(1,10802), (1,10803), (1,10825), \
              (2,945), (2,1107), (2,1108), (2,1116), (2,10784), (2,10801), (2,10807),\
              (2,10825),(3,945), (3,1107), (3,1108), (3,1115), (3,10807), (3,10825),(6,825),\
              (6,840), (6,855), (6,870), (6,885), (6,900), (6,915), (6,930), (6,945), (6,1107),\
              (6,1114), (6,10825)]
    for tup in reb_list:
        (run,zone) = tup
        data = reader.readAllCyclesForZone(run, zone)
    ...
    print("Runtime in minutes: ",(time.time()-start_time)//60)
    ###################################
    ### ^^^  MY CODE ENDS HERE  ^^^ ###
    ###################################    
